...
//	MaxPQ<Integer> spotifyQueue = new MaxPQ<Integer>();
...
class MaxPQ<Key> implements Iterable<Key> {
    ...
    public MaxPQ(int initCapacity, Comparator<Key> comparator, String[] URL) {
    	this.comparator = comparator;
    	pq = (Key[]) new Object[initCapacity + 1];
    	this.URL = URL;
    }
    ...
    private void resize(int capacity) {
    	...
    	String tempURL[] = new String[capacity];
    	for (int i = 1; i <= n; i++) {
    		temp[i] = pq[i];
    		tempURL[i] = URL[i];
    	}
